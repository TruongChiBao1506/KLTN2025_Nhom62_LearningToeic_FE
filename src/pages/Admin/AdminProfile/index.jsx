  ...
  return (
    <div data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">
      ...
      >
        <nav>
          <ol
            className="cd-breadcrumb custom-separator d-flex align-items-center mb-0"
            style={{ gap: 16 }}
          >
            <li className="current d-flex align-items-center">
              <span
                style={{
                  background:
                    "linear-gradient(135deg, #4f8cff 60%, #a6c1ee 100%)",
                  borderRadius: "50%",
                  width: 40,
                  height: 40,
                  display: "inline-flex",
              ...
              <span
                className="fw-bold"
                style={{ color: "#4f8cff", fontSize: 22 }}
              >
                Profile
              </span>
            </li>
