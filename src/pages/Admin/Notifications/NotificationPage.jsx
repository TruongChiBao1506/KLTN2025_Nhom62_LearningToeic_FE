...
const NotificationPage = () => {
  ...
  const notifications = getNotificationsByRole(allNotifications, 'admin');
  
  // Get admin user info
  const adminUserData = JSON.parse(localStorage.getItem('user') || '{}');
  ...
  useEffect(() => {
    document.title = "Thông báo | Admin Dashboard";
  }, []);
        ...
        <div className="notif-header-bar">
          ...
          {notifications.length > 0 && notifications.some(n => !n.isRead) && (
            <button
              ...
              onClick={() => dispatch(markAllAsRead(adminUserData._id || adminUserData.id))}
            >
