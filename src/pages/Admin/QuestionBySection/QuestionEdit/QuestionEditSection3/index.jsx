...
const EditQuestionSection3 = ({ sectionId, groupId, retrieveQuestions }) => {
                  ...
                  <div className="col-md-4" key={q.questionId}>
                    ...
                    <div className="form-group mb-3">
                      ...
                      >
                        ...
                        <option value="[Part 3] Câu hỏi kết hợp bảng biểu">
                          [Part 3] Câu hỏi kết hợp bảng biểu
                        </option>
                        <option value="[Part 3] Câu hỏi về chi tiết cuộc hội thoại">
                          [Part 3] Câu hỏi về chi tiết cuộc hội thoại
                        </option>
                        <option value="[Part 3] Câu hỏi về chủ đề, mục đích">
                          [Part 3] Câu hỏi về chủ đề, mục đích
                        </option>
                        <option value="[Part 3] Câu hỏi về danh tính người nói">
                          [Part 3] Câu hỏi về danh tính người nói
                        </option>
                        <option value="[Part 3] Câu hỏi về địa điểm hội thoại">
                          [Part 3] Câu hỏi về địa điểm hội thoại
                        </option>
                        <option value="[Part 3] Câu hỏi về hàm ý câu nói">
                          [Part 3] Câu hỏi về hàm ý câu nói
                        </option>
                        <option value="[Part 3] Câu hỏi về hành động tương lai">
                          [Part 3] Câu hỏi về hành động tương lai
                        </option>
                        <option value="[Part 3] Câu hỏi về yêu cầu, gợi ý">
...
export default EditQuestionSection3;