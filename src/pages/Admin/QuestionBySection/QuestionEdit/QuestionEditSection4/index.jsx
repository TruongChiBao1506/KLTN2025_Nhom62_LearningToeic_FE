...
const NUM_QUESTIONS = 3; // Sửa lại nếu group này có số câu khác

const QuestionEditSection4 = ({ sectionId, groupId, retrieveQuestions, onClose }) => {
  ...
  const updateGroupAndQuestions = async (values, { setSubmitting }) => {
    try {
      ...
      for (let idx = 0; idx < questions.length; idx++) {
        ...
        formData.append("questionType", "listening"); // ✅ Set questionType là "listening" cho Part 4
...
export default QuestionEditSection4;