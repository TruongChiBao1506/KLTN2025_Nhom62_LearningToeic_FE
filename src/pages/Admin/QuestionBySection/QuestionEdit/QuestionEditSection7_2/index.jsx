...
const EditQuestionSection7_2 = ({ sectionId, groupId, retrieveQuestions, onClose }) => {
  ...
  // Dynamic validation schema for 5 questions
  ...
  return (
    <div className="edit-question-section7-2-page">
              ...
              <div key={idx} className="col-md-6 mb-4">
                ...
                <div className="form-group mb-3">
                  ...
                  <input
                    ...
                    className={`form-control border-secondary custom-font ${
                      formik.touched[`questionExplanation${idx}`] && formik.errors[`questionExplanation${idx}`] ? 'is-invalid' : ''
                    }`}
...
export default EditQuestionSection7_2;