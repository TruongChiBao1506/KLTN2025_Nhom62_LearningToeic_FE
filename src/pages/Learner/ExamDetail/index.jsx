      ...
      const examData = {
        ...
        questions: (response.questions || []).map((q, index) => ({
          ...
          image: q.questionImage
            ? `${process.env.LOCALHOST}/images/${q.questionImage}`
            : q.imageUrl ||
              q.image ||
              (q.imagePath ? `${process.env.LOCALHOST}/${q.imagePath}` : null),
          audio: q.questionAudio
            ? `${process.env.LOCALHOST}/audios/${q.questionAudio}`
            : q.audioUrl ||
              q.audio ||
              (q.audioPath ? `${process.env.LOCALHOST}/${q.audioPath}` : null),
          _originalData: q,
        })),
