...
const Achievements = () => {
  ...
  useEffect(() => {
    ...
    setStats({
      ...
      rareAchievements: mockAchievements.filter(
        (a) => a.unlocked && (a.rarity === "epic" || a.rarity === "legendary")
      ).length,
    });
  }, []);
  ...
  return (
    <div className="achievements-container">
      <div className="achievements-header">
        <h1>⭐ Thành tích</h1>
        <p>
          Theo dõi tiến độ và mở khóa các thành tích đặc biệt trong hành trình
          học TOEIC!
        </p>
      </div>
      ...
      <div className="achievements-content">
        <div className="achievements-main">
          ...
          <div className="achievements-tabs">
            ...
            >
              🔒 Chưa mở khóa (
              {achievements.length - stats.unlockedAchievements})
            </button>
          </div>
