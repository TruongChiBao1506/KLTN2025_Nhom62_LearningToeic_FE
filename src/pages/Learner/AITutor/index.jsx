...
const AITutor = () => {
    ...
    const initialMessages = [
      {
        id: 1,
        type: 'ai',
        content: 'Xin chào! Tôi là AI Tutor của bạn. Tôi có thể giúp bạn học TOEIC, giải thích ngữ pháp, từ vựng và làm bài tập. Bạn muốn học gì hôm nay?',
  ...
  const personalities = [
    { id: 'friendly', name: 'Thân thiện', description: 'Vui vẻ và khuyến khích' },
    { id: 'professional', name: 'Chuyên nghiệp', description: 'Nghiêm túc và chi tiết' },
    { id: 'patient', name: 'Kiên nhẫn', description: 'Giải thích chậm và rõ ràng' }
  ];
  ...
  const clearChat = () => {
    setMessages([{
      id: 1,
      type: 'ai',
      content: 'Chat đã được xóa. Bạn muốn bắt đầu cuộc trò chuyện mới về chủ đề gì?',
      timestamp: new Date().toISOString(),
      avatar: '🤖'
    }]);
  };
          ...
          <div className="sidebar-section">
            ...
            <div className="stats">
              ...
              <div className="stat-item">
                ...
                <span className="stat-value">{topics.find(t => t.id === currentTopic)?.name}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="input-area">
            <div className="input-container">
              <textarea
                ...
                placeholder={`Hỏi về ${topics.find(t => t.id === currentTopic)?.name.toLowerCase()}...`}
                rows="3"
              />
              <button 
                className="send-btn"
            ...
            <div className="input-hints">
              <span>💡 Gợi ý: "Giải thích thì hiện tại", "Từ vựng về kinh doanh", "Tips làm bài nghe"</span>
            </div>
          </div>
        </div>
      </div>
