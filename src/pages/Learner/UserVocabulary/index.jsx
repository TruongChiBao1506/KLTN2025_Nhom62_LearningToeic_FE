...
const UserVocabulary = () => {
  ...
  const practicePronunciation = (index) => {
    ...
    recognition.onresult = (event) => {
      ...
      const isCorrect =
        lowerTranscript === userVocabulary.vocabulary.word.toLowerCase();
                        ...
                        <table className="table">
                          ...
                          <tbody>
                            {userVocabularies.map((userVocabulary, index) => (
                              <tr
                                key={userVocabulary.userVocabularyId}
                              ...
                              >
                                ...
                                <td>
                                  <img
                                    src={getImageUrl(
                                      userVocabulary.vocabulary.image
                                    )}
                                ...
                                <td>
                                  <button
                                    className="btn btn-light"
                                    onClick={() => practicePronunciation(index)}
                                  >
                                    <i
