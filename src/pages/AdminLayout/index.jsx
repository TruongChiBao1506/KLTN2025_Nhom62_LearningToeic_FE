...
import HeaderComponent from '../../components/Layouts/AdminHeader';
import TokenManager from '../../components/Layouts/CheckAccessToken';
...
const AdminLayout = () => {
    ...
    return (
        <div className="d-flex" id="wrapper">
            {/* Token Manager - equivalent to CheckAccessToken */}
            <TokenManager />
            
            {/* Sidebar */}
            <Sidebar isToggled={!isSidebarOpen} />
