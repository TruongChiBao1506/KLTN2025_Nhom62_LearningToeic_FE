...
const getLimitedPassage = (groupText) => {
  if (!groupText) return "";
  return groupText.length > MAX_PASSAGE_LENGTH
    ? groupText.slice(0, MAX_PASSAGE_LENGTH) + "..."
    : groupText;
};

const TableSection5To7 = ({
  paginatedQuestions,
  currentPage,
  ITEMS_PER_PAGE,
  sectionId,
  ...
  return (
    <div className="table-section5-to-7">
                  ...
                  <td rowSpan={groupedQuestions.length}>
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: getLimitedPassage(question.questionGroup.groupText),
                      }}
                    />
                  </td>
                )}
...
export default TableSection5To7;