...
const TableSpeaking8To10 = ({
  ...
  return (
    <div className="table-speaking8to10">
            ...
            return (
              <React.Fragment key={groupId}>
                <tr className="table-row shadow-on-hover align-middle">
                  ...
                  <td rowSpan={questions.length + 1}>
                    {firstQuestion.questionGroup?.groupImage ? (
                      <img
                        src={getImageUrl(firstQuestion.questionGroup.groupImage)}
                        alt="Group Image"
                  ...
                  <td rowSpan={questions.length + 1}>
                    <div
                      dangerouslySetInnerHTML={{
                        __html: firstQuestion.questionGroup?.groupText || firstQuestion.questionText || "No text",
                      }}
...
export default TableSpeaking8To10;
