...
const getLimitedScript = (script) => {
  if (!script) return "";
  return script.length > MAX_SCRIPT_LENGTH
    ? script.slice(0, MAX_SCRIPT_LENGTH) + "..."
    : script;
};

const QuestionListSection3 = ({
  paginatedQuestions,
  currentPage,
  ITEMS_PER_PAGE,
  getImageUrl,
  ...
  retrieveQuestions,
  QuestionService,
  handleShowEditModal, // thêm prop này để mở modal chỉnh sửa
}) => {
              ...
              <tr key={question._id} className="table-row align-middle">
                ...
                {index === 0 && (
                  <td
                    ...
                    rowSpan={groupedQuestions.length}
                  >
                    <img
                ...
                {index === 0 && (
                  <td rowSpan={groupedQuestions.length}>
                    <audio
                      controls
                      src={getAudioUrl(question.questionGroup.groupAudio)}
                    >
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: getLimitedScript(
                          question.questionGroup.groupScript
                        ),
                      }}
                    />
                  </td>
...
export default QuestionListSection3;