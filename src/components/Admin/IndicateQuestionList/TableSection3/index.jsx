...
const Part3QuestionList = ({
    ...
    const submitQuestions = async () => {
        ...
        try {
            ...
            toast.success("Chỉ định câu hỏi Phần 3 thành công", { autoClose: 1000 });
        } catch {
            toast.error("Chỉ định câu hỏi Phần 3 thất bại", { autoClose: 1000 });
        }
        setSelectedQuestions([]);
        setIsSubmitEnabled(false);
            ...
            <table className="table text-center table-bordered shadow">
                <thead className="shadow">
                    <tr className="align-middle">
                        ...
                        <th>SELECTED {selectedQuestions.length}/39</th>
                        <th>No.</th>
                        <th>CONTENT</th>
                        <th>A</th>
                        <th>B</th>
...
export default Part3QuestionList;