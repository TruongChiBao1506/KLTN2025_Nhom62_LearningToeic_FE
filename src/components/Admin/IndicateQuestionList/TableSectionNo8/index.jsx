...
const TableSectionNo8 = ({ paginatedQuestions, currentPage, ITEMS_PER_PAGE, sectionId, testId, retrieveQuestions }) => {
    ...
    const submitQuestions = async () => {
        ...
        try {
            ...
            toast.success('Chỉ định câu hỏi Speaking (8) thành công ', {
                autoClose: 1000
            });
        } catch (error) {
            console.log(error);
            toast.error('Chỉ định câu hỏi Speaking (8) thất bại ', {
                autoClose: 1000
            });
        }
    ...
    const handleCheckboxChange = (questionId) => {
        ...
        setIsSubmitEnabled(selectedQuestions.length >= 1);
    };
...
export default TableSectionNo8;