...
const ExamQuestionList = ({
  ...
  const normalizedExamQuestions = Array.isArray(examQuestions)
    ? examQuestions
    : [];
  ...
  const getItemStatus = (item) => {
    return item.questionStatus !== undefined
      ? item.questionStatus
      : item.examQuestionStatus !== undefined
      ? item.examQuestionStatus
            ...
            {isLoading ? (
              <div className="text-center py-5">
                ...
                <p className="mt-2 text-muted">
                  Đang tải danh sách exam questions...
                </p>
              </div>
            ) : (
              <>
                      ...
                      <table className="table text-center table-hover shadow">
                        ...
                        <tbody>
                          {paginatedExamQuestions.map((examQuestion, index) => (
                            <tr
                              key={
                                getItemId(examQuestion) || `question-${index}`
                              }
                            ...
                            >
                              ...
                              <td>
                                <div
                                  title={
                                    examQuestion.questionContent || "No content"
                                  }
                                >
                                  {truncateText(
                              ...
                              <td>
                                <div
                                  title={examQuestion.optionA || "No option A"}
                                >
                                  {truncateText(
                                    examQuestion.optionA || "No option A",
                                    20
                                  )}
                                </div>
                              </td>
                              <td>
                                <div
                                  title={examQuestion.optionB || "No option B"}
                                >
                                  {truncateText(
                                    examQuestion.optionB || "No option B",
                                    20
                                  )}
                                </div>
                              </td>
                              <td>
                                <div
                                  title={examQuestion.optionC || "No option C"}
                                >
                                  {truncateText(
                                    examQuestion.optionC || "No option C",
                                    20
                                  )}
                                </div>
                              </td>
                              <td>
                                <div
                                  title={examQuestion.optionD || "No option D"}
                                >
                                  {truncateText(
                                    examQuestion.optionD || "No option D",
                                    20
                                  )}
                                </div>
                              </td>
                              ...
                              <td>
                                <div
                                  title={
                                    examQuestion.questionScript || "No script"
                                  }
                                  dangerouslySetInnerHTML={{
                                    __html: getLimitedScript(
                                      examQuestion.questionScript || ""
                                    ),
                                  }}
                                />
                              </td>
                              <td>
                                <div
                                  title={
                                    examQuestion.questionPassage || "No passage"
                                  }
                                  dangerouslySetInnerHTML={{
                                    __html: getLimitedPassage(
                              ...
                              <td>
                                <span className="badge bg-info">
                                  {(() => {
                                    const part =
                                      examQuestion.questionPart ||
                                      examQuestion.partNumber;
                                    if (
                                      part !== undefined &&
                                      part !== null &&
                                      part !== ""
                          ...
                          {paginatedExamQuestions.length === 0 &&
                    ...
                    {filteredExamQuestions.length > 0 && (
                      <div className="d-flex justify-content-center mt-3 fw-lighter fst-italic">
                        <p>
                          ...
                          {filteredExamQuestions.length} kết quả
                          {pagination && (
                      ...
                      filteredExamQuestions.length === 0 && (
                        <div className="text-center py-5">
                          ...
                          <p className="text-muted">
                            Không có exam question nào khớp với từ khóa "
                            {searchText}"
                          </p>
                          <button
