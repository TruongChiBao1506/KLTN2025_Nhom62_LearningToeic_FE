...
import { User, LogOut, Bell, Clock, ArrowRight, BookOpen } from 'lucide-react';
...
const TeacherHeader = ({ toggleSidebar }) => {
    ...
    const notifications = useMemo(() => 
        getNotificationsByRole(allNotifications, 'teacher'), 
        [allNotifications]
    );
    
    const roleCounts = useMemo(() => 
        getRoleSpecificCounts(allCounts, 'teacher'),
        [allCounts]
    );
    ...
    const handleToggleClick = () => {
        console.log('🔘 Teacher Sidebar toggle button clicked');
        if (toggleSidebar) {
            toggleSidebar();
        } else {
                ...
                >
                    ...
                    >
                        ...
                        <Button
                            type="link"
                            size="small"
                            onClick={() => dispatch(markAllAsRead(teacherUserData?.id))}
                            style={{
                                padding: "4px 8px",
                                fontSize: "12px",
                ...
                label: (
                    <div style={{ 
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                            <Avatar
                                size={48}
                                src={getImageUrl(teacherUserData?.avatar)}
                                style={{
                                    background: "#2C5F8D",
                            ...
                            >
                                {teacherUserData?.name?.charAt(0) || teacherUserData?.username?.charAt(0) || "T"}
                            </Avatar>
                            <div>
                                <div style={{ 
                                    fontSize: "12px", 
                                    ...
                                    {teacherUserData?.name || teacherUserData?.username || "Teacher"}
                                </div>
                                <div style={{ 
                                    fontSize: "12px", 
                                    color: "#64748b"
                                }}>
                                    {teacherUserData?.email || "teacher@example.com"}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            },
            {
                ...
                label: (
                    ...
                    >
                        ...
                        <span style={{ fontWeight: "600", fontSize: "12px", color: "#1f2937" }}>Chế độ học viên</span>
                    </Link>
                ),
            },
            {
