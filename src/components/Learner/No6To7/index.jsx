                ...
                <div className="col-md-12">
                    <div className="card specific-card mt-3">
                        <div className="card-body">
                            ...
                            <h2 className="text-center my-3">Writing: Trả lời yêu cầu bằng văn bản</h2>
                            ...
                            <span className="badge bg-success-subtle border border-success-subtle text-success-emphasis rounded-pill">Chất lượng và sự đa dạng của các mẫu câu sử dụng</span>
                                ...
                                <div className="word-item">
                                    <div className="mb-5">
                                        ...
                                        <div className="word-info">
                                            ...
                                            <br />
                                            <strong className="ms-3">Text:</strong>
