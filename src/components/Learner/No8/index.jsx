                ...
                <div className="col-md-12">
                    <div className="card specific-card mt-3">
                        <div className="card-body">
                            ...
                            <h2 className="text-center my-3">Writing: Viết một bài văn bày tỏ quan điểm</h2>
                            <h5 className="card-title">Directions:</h5>
                            <p className="card-text">
                                Trong phần thi này, bạn sẽ viết một bài luận để trả lời một câu hỏi yêu cầu bạn trình bày, giải
                                thích và ủng hộ quan điểm của mình về một vấn đề. Thông thường, một bài luận hiệu quả sẽ chứa
                                tối thiểu 300 từ.
                                Câu trả lời của bạn sẽ được tính điểm dựa trên việc liệu ý kiến của bạn có được hỗ trợ bằng các
                                lý do và/hoặc ví dụ, ngữ pháp, từ vựng và cách tổ chức hay không.
                            </p>
                            <h5 className="card-title">Tiêu chí đánh giá:</h5>
                            <span className="badge bg-success-subtle border border-success-subtle text-success-emphasis rounded-pill me-3">Quan điểm có được hỗ trợ bằng lý do hoặc bằng ví dụ hay
                                không?</span>
                            <span className="badge bg-success-subtle border border-success-subtle text-success-emphasis rounded-pill">Ngữ pháp</span>
                            <span className="badge bg-success-subtle border border-success-subtle text-success-emphasis rounded-pill mx-3">Từ vựng</span>
                            <span className="badge bg-success-subtle border border-success-subtle text-success-emphasis rounded-pill">Tổ chức sắp xếp bài viết</span>
                        </div>
                    </div>
                                ...
                                <div className="word-item">
                                    <div className="mb-5">
                                        ...
                                        <div className="word-info">
                                            ...
                                            <br />
                                            <strong className="ms-3">Text:</strong> {questions[currentIndex]?.questionText}
                                        </div>
                                        ...
                                        <div className="word-info mb-3" style={{ display: isTestSubmitted ? 'block' : 'none' }}>
                                            ...
                                            <div className="ms-3 border border-secondary p-2 border-2" dangerouslySetInnerHTML={{ __html: questions[currentIndex]?.suggestedAnswer }}></div>
                                        </div>
