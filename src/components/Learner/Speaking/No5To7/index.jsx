    ...
    const fetchedQuestions = [
      {
        id: 1,
        type: 'Câu hỏi 5',
        content: "Bạn sẽ nghe một công bố hoặc thông báo được đọc to. Sau đó, bạn sẽ được đặt một câu hỏi về những gì bạn đã nghe. Sau khi bạn nghe câu hỏi, bạn sẽ có 60 giây để trả lời câu hỏi nói về những gì bạn nghe thấy.",
        audioUrl: "https://example.com/question-audio-5.mp3",
        questionText: "Thông báo: Lưu ý gửi đến tất cả người dùng thư viện. Thư viện sẽ đóng cửa vào lúc 7 giờ tối hôm nay thay vì thời gian đóng cửa thông thường là 9 giờ tối do bảo trì hệ thống. Tất cả sách đã mượn hôm nay sẽ được gia hạn tự động thêm một ngày. Chúng tôi xin lỗi vì sự bất tiện này. Câu hỏi: Tại sao thư viện đóng cửa sớm hôm nay?"
      },
      {
        id: 2,
        type: 'Câu hỏi 6',
        content: "Bạn sẽ nghe một phần của cuộc hội thoại. Sau đó, bạn sẽ được đặt một câu hỏi về những gì bạn đã nghe. Sau khi bạn nghe câu hỏi, bạn sẽ có 60 giây để trả lời câu hỏi nói về những gì bạn nghe thấy.",
        audioUrl: "https://example.com/question-audio-6.mp3",
        questionText: "Hội thoại: A: Chúng ta dường như đã hết giấy in cho buổi họp chiều nay. B: Tôi sẽ đi lấy thêm ở phòng kho. A: Cảm ơn, nhưng tôi nghĩ chúng ta cần yêu cầu văn phòng đặt thêm để tuần sau sử dụng. B: Được rồi, tôi sẽ gửi email cho bộ phận mua hàng. Câu hỏi: Nhóm cần làm gì để chuẩn bị cho tuần tới?"
      },
      {
        id: 3,
        type: 'Câu hỏi 7',
        content: "Bạn sẽ nghe một đoạn hội thoại hoặc một bài nói ngắn. Sau đó, bạn sẽ được đặt một câu hỏi về những gì bạn đã nghe. Sau khi bạn nghe câu hỏi, bạn sẽ có 60 giây để trả lời câu hỏi dựa trên thông tin bạn đã nghe.",
        audioUrl: "https://example.com/question-audio-7.mp3",
        questionText: "Bài nói: Hôm nay, tôi muốn nói về một chủ đề quan trọng: biến đổi khí hậu. Nhiệt độ trung bình toàn cầu đã tăng 1 độ C so với thời kỳ tiền công nghiệp. Nếu không có hành động quyết liệt, sự ấm lên này có thể vượt quá 2 độ C, dẫn đến hậu quả thảm khốc cho hành tinh chúng ta. Các chính phủ trên toàn thế giới đã cam kết giảm phát thải khí nhà kính, nhưng cần có nhiều nỗ lực hơn nữa từ các doanh nghiệp và cá nhân. Câu hỏi: Theo bài nói, điều gì sẽ xảy ra nếu không có hành động quyết liệt về biến đổi khí hậu?"
      }
    ];
          ...
          <div className="card specific-card mt-3">
            <div className="card-body">
              ...
              <p className="card-text">
                Trong phần kiểm tra này, bạn sẽ nghe một đoạn ghi âm và trả lời câu hỏi liên quan.
                Bạn sẽ có <strong>45</strong> giây để chuẩn bị phản hồi. Sau đó, bạn sẽ có <strong>60</strong> giây để trả lời câu hỏi.
              </p>
                      ...
                      <div className="my-4">
                        <div className="card p-3 mb-3 question-card">
                          ...
                          <div className="audio-simulation mt-3">
                            <p><em>* Trong phiên bản thực, đây sẽ là file âm thanh cho câu hỏi.</em></p>
                          </div>
                        </div>
                        ...
                        <div className="card mt-3">
                          <div className="card-body">
                            ...
                            <ul>
                              ...
                              <li>Cung cấp ví dụ hoặc lý do để hỗ trợ câu trả lời của bạn</li>
                              <li>Tổ chức câu trả lời theo cấu trúc rõ ràng</li>
                              <li>Sử dụng từ nối để tạo tính mạch lạc cho câu trả lời</li>
